...
-- Add essential categories for the forum (remove existing ones first if they exist)
DELETE FROM categories WHERE name IN ('Human Enhancement', 'AI & Consciousness', 'Life Extension', 'Philosophy', 'Technology');
