...
const Resources = () => {
  ...
  const blogs: Blog[] = [
    ...
    {
      title: "Future of Humanity Institute Blog",
      author: "Oxford University",
      description: "Research and insights on existential risks, AI safety, and the long-term future of humanity from leading academics.",
      url: "https://www.fhi.ox.ac.uk/blog/",
      category: "Academic"
    },
    {
        ...
        <div className="max-w-4xl mx-auto px-8 py-16">
          <div className="mb-16">
            ...
            <p className="text-lg text-muted-foreground font-light">
              Curated collection of thinkers, books, and blogs exploring the future of humanity
            </p>
          </div>
